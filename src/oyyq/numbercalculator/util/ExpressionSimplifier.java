...
public class ExpressionSimplifier {
	 ...
	 * @param result The expression to add
	 * @param expressions The list
	 */
	private static void addToOrderedExpressionList(Expression result, ArrayList<Expression> expressions) {
	...
	/**
	 * <p>judges if <i>a</i> should before <i>b</i> in the final expression.</p>
	 * <b>rules:</b>
	 * <ol>
	...
	private static Expression simplifyDivideOne(Expression oldExpression) {
		...
		if (oldExpression.getOperator() == Operator.DIVIDE && oldExpression.getOperand2().getValue().equalsNumber(1)) {
			newExpression = new Expression(oldExpression.getOperand1(), Operator.MULTIPLY, oldExpression.getOperand2());
		}
	...
	private static Expression simplifyMultiplyOne(Expression oldExpression) {
		...
		if (oper.getPriority() == Operator.PRIORITY_PLUS_MINUS && operand1.getOperator() == Operator.MULTIPLY) {
		...
		if (oper.getPriority() == Operator.PRIORITY_PLUS_MINUS && operand2.getOperator() == Operator.MULTIPLY) {
